...
public class ThumbnailPlace {
    private String thumbnail_place_name, thumbnail_place_road;
    private int thumbnail_place_image, thumbnail_place_price;

    public ThumbnailPlace(String thumbnail_place_name, String thumbnail_place_road, int thumbnail_place_price, int thumbnail_place_image) {
    ...
    public int getThumbnail_place_image() {
        return thumbnail_place_image;
    }

    public void setThumbnail_place_image(int thumbnail_place_image) {
        this.thumbnail_place_image = thumbnail_place_image;
    }
}
